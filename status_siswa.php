...
<section class="apa " style="background-image: linear-gradient(rgba(30, 50, 70, 0.8), rgba(4, 97, 186,0.8)),  url(asset/img/pj.png); background-repeat: no-repeat; background-size:cover " >
    ...
    <form action="" method="post">
        ...
        <tr style="background-color:lightblue; ">
                    ...
                    <th width="160px" style="color:black; text-align:center; font-size:30px; border-radius:10px;">Aksi</th>
            </tr>
            </thead>
            <tbody>
            ...
            <tr>
                ...
                <a href="editdatastatus.php?nik=<?=$data['nik']; ?>" ><button type="button" class="btn btn-warning"><i  class="bi  bi-pencil-fill"></i></button></a>
                <a href="hapus_data_siswa_p.php?nik=<?=$data['nik']; ?>" onclick="return confirm('Anda yakin mau menghapus item ini ?')"><button type="button" class="btn btn-danger mt-1 mb-1"><i  class="bi bi-trash-fill"></i></button></a>
                <a href="detail.php?nik=<?=$data['nik']; ?>" ><button type="button" class="btn btn-success"><i class="bi bi-card-checklist"></i></button></a>
