...
?>
    ...
    <div class="row  ">
    <div class="col border p-1 rounded mt-2   shadow-lg p-3 mb-2 bg-body rounded">

        <h5 >Silahkan Upload File : </h5>
        <form action="proses_upload_berkas.php" method="post" enctype="multipart/form-data">
        <table class="table table-light border p-1 rounded mt-2   shadow-lg p-3 mb-2 bg-body rounded " border="0" cellpadding="6" >
            <tr>

            <P>Upload file dengan format PDG/JPG </P>
            <P>Nama file yang di Upload adalah Nama Pendaftar</P>
            <td>Upload Bukti Pendaftaran:</td>
            <tr>
            <td>Bukti Trasfer :</td><tr>
